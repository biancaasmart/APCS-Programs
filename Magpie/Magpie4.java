...
public class Magpie4
{
   ...
   /**
    ...
    private String transformIYouStatement(String statement)
    {
        ...
        int IBegin = findKeyword (statement, "I", 0);
        int YouBegin = findKeyword(statement, "you", 0);
        String middleString = statement.substring(IBegin + 2, YouBegin).trim();
        return "Why do you " + middleString + " me?";
    }
